...
def main():
    ...
    myNames = np.genfromtxt('NFLNames.csv', delimiter=',', dtype = 'str')
    myTrain = np.genfromtxt('NFLTrain.csv', delimiter=',', dtype = 'str')
    myTest = np.genfromtxt('NFLTest.csv', delimiter=',', dtype = 'str')
    
   
    # Determines the number of training examples.
    #totalTrain = np.shape(myTrain)[0]
